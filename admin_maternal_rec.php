...
// 1. DELETE LOGIC (Updated table name to maternal_registration)
...
// 2. FETCH PATIENTS (Updated Query: No "s", and using CONCAT for name)
$search = isset($_GET['search']) ? mysqli_real_escape_string($conn, $_GET['search']) : '';

$query = "SELECT u.*, 
          CONCAT(u.client_fname, ' ', u.client_lname) AS full_name,
...
<body>
    ...
    <div id="maternalModal" class="modal">
        <div class="modal-content">
            ...
            <div class="latest-record-box">
                ...
                <div class="stat-grid">
                    <div class="stat-box"><small>Weight</small><b id="last_weight">--</b></div>
                    <div class="stat-box"><small>BP</small><b id="last_bp">--</b></div>
                    <div class="stat-box"><small>Temp</small><b id="last_temp">--</b></div>
                </div>
            </div>
            <div style="margin-top: 25px; display: flex; justify-content: space-between;">
                <button type="button" class="btn-delete" id="del_btn">Delete Patient</button>
                <button onclick="closeModal()" style="background:#eee; padding:10px 20px; border-radius:10px;">Close</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function openModal(data) {
            ...
            document.getElementById('m_contact').innerText = data.contact || "N/A"; // Updated field name
            document.getElementById('m_lmp').innerText = data.lmp || "Not set";
            document.getElementById('m_blood').innerText = data.blood_type || "N/A"; // Updated field name
