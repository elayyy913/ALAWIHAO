...
<div class="sidebar" id="mySidebar">
    ...
    <div class="menu-item">
        ...
        <div id="reg" class="content-collapse" style="display: none;">
    ...
    <div class="menu-item">
        ...
        <div id="rec" class="content-collapse" style="display: none;">
    ...
    <div class="menu-item">
        ...
        <div id="sch" class="content-collapse" style="display: none;">
...
<script>
    // Function para i-toggle ang pagbukas/pagsara ng buong sidebar
    function toggleSidebar() {
        document.body.classList.toggle('sidebar-closed');
    }

    // Function para sa Collapsible sub-menus (Register, Records, Schedule)
    ...
    // Function para sa Real-time Search ng Health Topics
